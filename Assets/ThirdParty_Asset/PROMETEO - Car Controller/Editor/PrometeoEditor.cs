...
public class PrometeoEditor : Editor{
  ...
  private SerializedObject SO;
    ...
    private SerializedProperty CarSpeed;
  ...
  private void OnEnable(){
    ...
    SO = new SerializedObject(target);
        rpm = SO.FindProperty("rpm");
        CarSpeed = SO.FindProperty("carSpeed");
  ...
  public override void OnInspectorGUI(){
    ...
    GUILayout.Space(10);
        ...
        //
        //
        rpm.floatValue = EditorGUILayout.IntField("rpm",(int)rpm.floatValue);
        CarSpeed.floatValue = EditorGUILayout.IntField("Car Speed", (int)CarSpeed.floatValue);
